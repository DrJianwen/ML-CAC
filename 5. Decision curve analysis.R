...
dca(data=data, outcome="CT_CAC_above400", predictors=c("test_proba_log","test_proba_svm","test_proba_mlp","test_proba_rfc","test_proba_xgb"), smooth="TRUE")
